...
void stage1(Array &u, Array &v, Array &e, Array &u1, Array &v1, Array &e1,
  ...
  };
  {
    ...
    dr::mp::stencil_for_each(rhs_u1, e_view, u_view, u1_view);
  }
  ...
  };
  {
    ...
    dr::mp::stencil_for_each(rhs_v1, e_view, v_view, v1_view);
  }
  ...
  };
  {
    ...
    dr::mp::stencil_for_each(rhs_e1, e_view, u_view, v_view, e1_view);
  }
...
void stage2(Array &u, Array &v, Array &e, Array &u1, Array &v1, Array &e1,
  ...
  };
  {
    ...
    dr::mp::stencil_for_each(rhs_u2, e1_view, u1_view, u_view, u2_view);
  }
  ...
  };
  {
    ...
    dr::mp::stencil_for_each(rhs_v2, e1_view, v1_view, v_view, v2_view);
  }
...
void stage3(Array &u, Array &v, Array &e, Array &u2, Array &v2, Array &e2,
  ...
  };
  {
    ...
    auto u2_view = dr::mp::views::submdspan(u2.view(), start, end);
    auto u_view = dr::mp::views::submdspan(u.view(), start, end);
    dr::mp::stencil_for_each(rhs_u3, e2_view, u2_view, u_view);
  }
  ...
  };
  {
    ...
    auto v2_view = dr::mp::views::submdspan(v2.view(), start, end);
    auto v_view = dr::mp::views::submdspan(v.view(), start, end);
    dr::mp::stencil_for_each(rhs_v3, e2_view, v2_view, v_view);
  }
  ...
  };
  {
    ...
    auto v2_view = dr::mp::views::submdspan(v2.view(), start, end);
    auto e_view = dr::mp::views::submdspan(e.view(), start, end);
    dr::mp::stencil_for_each(rhs_e3, e2_view, u2_view, v2_view, e_view);
  }
...
int run(
  ...
  dr::mp::fill(dudt, 0);
  dr::mp::fill(dvdt, 0);
  dr::mp::halo(dedt).exchange_begin();
  dr::mp::halo(dudt).exchange_begin();
  dr::mp::halo(dvdt).exchange_begin();
