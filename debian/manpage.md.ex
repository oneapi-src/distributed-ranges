...
dr - program to do something

# SYNOPSIS

**dr** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
...
:   The system-wide configuration file to control the behaviour of
    dr. See **foo.conf**(5) for further details.
...
**dr** provides some return codes, that can be used in scripts:
