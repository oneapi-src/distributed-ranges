% distributed-ranges(SECTION) | User Commands
%
% "July  2 2024"
...
distributed-ranges - program to do something

# SYNOPSIS

**distributed-ranges** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**distributed-ranges** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **distributed-ranges** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**distributed-ranges** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    distributed-ranges. See **foo.conf**(5) for further details.
...
**distributed-ranges** provides some return codes, that can be used in scripts:
