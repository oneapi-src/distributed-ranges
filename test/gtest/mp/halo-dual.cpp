...
TYPED_TEST(HaloDual, perf_test_both) {
  if (TEST_TYPE == DualTestType::NON_RAMPING) {
    for (size_t i = 0; i < NON_RAMPING_RETRIES; i++) {
  ...
  if (TEST_TYPE == DualTestType::RAMPING_1D) {
    for (size_t i = 0; i < RAMPING_RETRIES; i++) {
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 0)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 1)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 2)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 3)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 4)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 5)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 6)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 7)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 8)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 9)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 10)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 11)
      // VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 12)
      VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 13)
      VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 14)
      VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 15)
      VARIED_KERNEL_TEST_CASE(DISTRIBUTED_VECTOR_SIZE, HALO_SIZE, 16)
    }
  ...
  for (size_t retry = 0; retry < RAMPING_RETRIES; retry++) {
    for (size_t size = DISTRIBUTED_VECTOR_SIZE; size <= DISTRIBUTED_VECTOR_SIZE; size *= 10) {
