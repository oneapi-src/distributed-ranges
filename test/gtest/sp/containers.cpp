...
TYPED_TEST(DistributedVectorTest, fill_constructor) {
  EXPECT_TRUE(equal_gtest(typename TestFixture::DistVec(10, 1),
...
public:
  using DeviceVec = dr::sp::device_vector<typename AllocT::value_type, AllocT>;
};
