...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "mdspan-0.6.0"
  WORKING_DIRECTORY "/nfs/site/home/nowakmat/work/distributed-ranges-sort/build-icpx/_deps/mdspan-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "mdspan-0.6.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("mdspan-0.6.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/mdspan-0.6.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/nfs/site/home/nowakmat/work/distributed-ranges-sort/build-icpx/_deps/mdspan-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/nfs/site/home/nowakmat/work/distributed-ranges-sort/build-icpx/_deps/mdspan-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
